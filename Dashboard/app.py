...
def reactive_calc_combined():
    ...
    temp = round(random.uniform(33, 35), 1)
...
ui.page_opts(title="PyShiny Express: Live Data Enhancement", fillable=True)
...
with ui.sidebar(open="open"):
    ...
    ui.h2("Temperature in Pensacola Florida", class_="text-center")
    ui.p(
        "A demonstration of real-time temperature readings in Pensacola, FL.",
        class_="text-center",
    )
    ui.hr()
    ui.h6("Links:")
    ui.a(
        "GitHub Source",
        href="https://github.com/scmiller77/cintel-05-cintel/",
        target="_blank",
    )
    ui.a(
        "GitHub App",
        href="https://scmiller77.github.io/cintel-05-cintel/",
        target="_blank",
    )
...
with ui.layout_columns():
    ...
    with ui.card(full_screen=True):
        ui.card_header("Current Date and Time", class_="bg-gradient-red-yellow")
...
with ui.card(full_screen=True):
        ...
        ui.card_header("Most Recent Readings", class_="bg-gradient-red-yellow")
...
with ui.card():
    ui.card_header("Chart with Current Trend", class_="bg-gradient-red-yellow")
